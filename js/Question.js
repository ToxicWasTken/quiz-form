class Question {
  ...
  constructor() {
   ...
   //Create a input box to enter the number
    ...
    this.input2 = createInput("Enter corrrect option number here-");
  ...
  display(){
    ...
    this.question.html("What starts and ends with an  E but has only one letter? ")
    this.question.position(350, 50);

    this.option1.html("a. Estimate")
    this.option2.html("b. Everyone")
    this.option3.html("c. Envelope")
